    ...
    <div className="w-full h-full flex flex-col relative overflow-hidden">
      ...
      <main className="flex-1 flex px-16 py-12 gap-16">
        ...
        <div className="w-2/5 space-y-10">
          ...
          {/* Featured Story Card */}
          {featuredStory && (
            <Card className="bg-amber-50/95 rounded-[2rem] p-12 super-magical-shadow relative overflow-hidden border-4 border-amber-200">
              {/* Magical Background Elements */}
              <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-amber-300 to-amber-500 rounded-full -translate-y-12 translate-x-12 opacity-20"></div>
              <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-amber-400 to-amber-600 rounded-full translate-y-8 -translate-x-8 opacity-20"></div>
              <div className="absolute top-1/2 right-8 text-6xl opacity-20 floating-star">✨</div>
              
              <div className="relative z-10">
                <div className="flex items-center space-x-4 mb-8">
                  <div className="w-6 h-6 bg-gradient-to-r from-amber-500 to-amber-700 rounded-full"></div>
                  <span className="text-amber-800 font-bold text-2xl tracking-wide title-font">🌟 FEATURED STORY 🌟</span>
                </div>
                
                <div className="w-full h-64 rounded-3xl overflow-hidden mb-8 super-magical-shadow border-4 border-amber-300">
                  <img 
                ...
                <h3 className="title-font text-4xl bg-gradient-to-r from-amber-900 via-amber-700 to-amber-600 bg-clip-text text-transparent mb-4" data-testid="text-featured-title">
                  {featuredStory.title}
                </h3>
                <p className="text-amber-800 text-xl leading-relaxed mb-8 font-medium" data-testid="text-featured-description">
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <span className="text-lg text-amber-700 bg-amber-100 px-6 py-3 rounded-2xl flex items-center space-x-2 font-semibold">
          ...
          <Button 
            ...
            className="create-button w-full text-white p-12 rounded-3xl font-bold text-3xl title-font tracking-wide relative overflow-hidden border-4 border-amber-300"
        ...
        <div className="flex-1 space-y-10">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="title-font text-5xl bg-gradient-to-r from-amber-900 via-amber-700 to-amber-600 bg-clip-text text-transparent mb-3" data-testid="text-library-title">
                📚 Your Magical Library
              </h2>
              <p className="text-amber-800 text-2xl font-semibold">Choose your next bedtime adventure! ✨</p>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <Button 
                variant="ghost" 
                className="px-8 py-4 bg-gradient-to-r from-amber-500 to-amber-700 hover:from-amber-600 hover:to-amber-800 rounded-2xl text-white font-bold text-xl transition-all duration-300 transform hover:scale-105 super-magical-shadow flex items-center space-x-3"
          ...
          <div className="space-y-8">
            {storiesLoading ? (
              ...
              regularStories.map((story) => (
                <Card key={story.id} className="story-card rounded-3xl p-8 flex items-center space-x-8 border-4 border-amber-100">
                  {/* Story thumbnail */}
                  <div className="w-32 h-32 story-thumbnail rounded-3xl flex items-center justify-center super-magical-shadow flex-shrink-0 overflow-hidden border-4 border-amber-200">
                    <img 
                      src={story.thumbnail || ""} 
                  ...
                  <div className="flex-1">
                    <h3 className="font-bold text-3xl bg-gradient-to-r from-amber-800 to-amber-600 bg-clip-text text-transparent mb-3 title-font" data-testid={`text-title-${story.id}`}>
                      {story.title}
                    </h3>
                    <p className="text-amber-800 text-lg mb-4 font-medium leading-relaxed" data-testid={`text-description-${story.id}`}>
                      {story.description}
                    </p>
                    <div className="flex items-center space-x-6 text-lg text-amber-700 font-semibold">
                      <span className="flex items-center space-x-2 bg-amber-100 px-4 py-2 rounded-2xl">
                        <Star className="w-5 h-5" />
                        <span>{story.genre}</span>
                      </span>
                      <span className="flex items-center space-x-2 bg-amber-50 px-4 py-2 rounded-2xl">
                        <Clock className="w-5 h-5" />
                        <span>{story.duration} min</span>
                      </span>
                      <span className="flex items-center space-x-2 bg-amber-200 px-4 py-2 rounded-2xl">
